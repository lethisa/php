...
<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
    ...
    <div class="navbar-header">
        ...
        <a class="navbar-brand" href="index.php">CMS Backend</a>
    </div>
    <!-- Top Menu Items -->
        ...
        <ul class="nav navbar-nav side-nav">
            ...
            <li>
                ...
                <ul id="posts_dropdown" class="collapse">
                    ...
                    <li>
                        <a href="view_post.php?source=add_post">Add Post</a>
                    </li>
                </ul>
            </li>
            <li>
            ...
            <li>
                <a href="./view_comment.php"><i class="fa fa-fw fa-file"></i> Comments </a>
            </li>
            <li>
                ...
                <ul id="demo" class="collapse">
                    ...
                    <li>
                        <a href="view_user.php?source=add_user">Add User</a>
                    </li>
                </ul>
            </li>
